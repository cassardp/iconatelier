...
struct AIStyle: Identifiable, Hashable {
    ...
    static let all: [AIStyle] = [
        ...
        AIStyle(
            id: "stacked-cards",
            label: "Stacked",
            promptFragment: "an iOS app-icon interior element composed of stacked flat layers seen in a slight isometric tilt, in the visual language of Apple icons like Wallet, Wallet passes, Stocks and Files, not an illustration of a real-world stack of objects; two to four overlapping rounded rectangular or squircle layers staggered diagonally with subtle vertical offset, each layer flat with a distinct solid Apple-style hue or a smooth two-stop gradient, layers arranged so the subject's idea reads through the composition (color choice, label area, small abstracted glyph on the front layer); ultra-clean flat finish, crisp anti-aliased vector edges, perfectly uniform rounded corners, no outlines, no texture, no grain, no shading beyond an extremely subtle linear gradient on each layer to suggest depth; very soft narrow drop shadow between layers only, no shadow under the whole stack; restrained palette of two to four harmonious saturated hues; no text or lettering. Single centered composition, isolated on a plain neutral background, generous symmetrical padding, no frame, no scene, no environment, no perspective floor, no duplicates, no extra props."
        ),
        AIStyle(
            id: "petal-bloom",
            label: "Bloom",
            promptFragment: "an iOS app-icon mark formed as a radial bloom of petals or lobes around a center, in the visual language of the Photos icon and Game Center bubbles, not an illustration of a real-world flower; four to seven simplified rounded petal or lobe shapes arranged with perfect radial symmetry around a central point, each petal a clean rounded vector shape, smooth swelling silhouettes, slight overlaps between adjacent petals with gentle blend modes producing harmonious mixed hues at the overlaps; each petal filled with a smooth multi-stop radial or linear gradient, saturated Apple-style palette of three to six closely related vibrant hues distributed evenly around the wheel; perfectly flat in finish beyond the gradients, no outlines, no 3D, no texture, no grain; crisp anti-aliased vector edges, balanced optical proportions, generous rounded petal tips; no text or lettering. Single centered bloom, isolated on a plain neutral background, generous symmetrical padding, no frame, no badge behind the bloom, no scene, no environment, no cast shadow, no duplicates, no extra elements."
        ),
        AIStyle(
            id: "mono-outline",
            label: "Outline",
